            ...
            <div class="as-mobile-menu">
                <ul>
                    <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            <li class="menu-item-has-children">
                                <a href="signup.html#">Multipage</a>
                                <ul class="sub-menu">
                ...
                <div class="widget_shopping_cart_content">
                    <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="signup.html#" class="remove remove_from_cart_button"><i
                                    class="far fa-times"></i></a>
                            <a href="signup.html#"><img src="/assets/img/product/product_thumb_1_1.png"
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="signup.html#" class="remove remove_from_cart_button"><i
                                    class="far fa-times"></i></a>
                            <a href="signup.html#"><img src="/assets/img/product/product_thumb_1_2.png"
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="signup.html#" class="remove remove_from_cart_button"><i
                                    class="far fa-times"></i></a>
                            <a href="signup.html#"><img src="/assets/img/product/product_thumb_1_3.png"
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="signup.html#" class="remove remove_from_cart_button"><i
                                    class="far fa-times"></i></a>
                            <a href="signup.html#"><img src="/assets/img/product/product_thumb_1_4.png"
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="signup.html#" class="remove remove_from_cart_button"><i
                                    class="far fa-times"></i></a>
                            <a href="signup.html#"><img src="/assets/img/product/product_thumb_1_5.png"
                        ...
                        <ul class="navbar-top-right header-links">
                            ...
                            <li>
                                <div class="header-social">
                                    ...
                                    <a href="signup.html#"><i class="fab fa-twitter"></i></a>
                                    <a href="signup.html#"><i class="fab fa-linkedin-in"></i></a>
                                    <a href="signup.html#"><i class="fab fa-instagram"></i></a>
                                </div>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8">
                    <form action="https://angfuzsoft.com/html/tayde/demo/mail.php" method="POST"
                        ...
                        <h2 class="form-title fw-extrabold">Signup</h2>
                        <p class="form-text mb-md-5 mb-4">Already have an account? <a href="login.html">Log in</a></p>
                        <div class="row">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control style-white" name="user" id="user"
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control style-white" name="password"
                                    id="password" placeholder="Password">
                                <a class="input-icon" href="signup.html#"><i class="fal fa-eye"></i></a>
                            </div>
                            <div class="form-group col-12 text-start align-self-center">
                                <input class="style2" type="checkbox" id="remember">
                                <label for="remember">Accept the Terms and <a class="text-underline"
                                        href="signup.html#">Privacy Policy</a> </label>
                            </div>
                            <div class="form-btn col-12 text-center">
                                <button class="as-btn w-100">Sign Up</button>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-xxl-3 col-xl-3">
                        <div class="widget footer-widget">
                            <div class="as-widget-about">
                                ...
                                <div class="as-social">
                                    <a class="facebook" href="signup.html#"><i class="fab fa-facebook-f"></i></a>
                                    <a class="goggle" href="signup.html#"><i class="fab fa-google-plus-g"></i></a>
                                    <a class="twitter" href="signup.html#"><i class="fab fa-twitter"></i></a>
                                    <a class="pinterest" href="signup.html#"><i class="fab fa-pinterest-p"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="copyright-wrap" data-bg-src="/assets/img/bg/copyright_bg.png">
            <div class="container">
                <p class="copyright-text text-center">Copyright <i class="fal fa-copyright"></i> 2023 By <a
                        href="signup.html#">Tayde</a>. All Rights Reserved.</p>
            </div>
        </div>
    </footer>
 ...
 ******************************** -->
    ...
    <!-- Scroll To Top -->
    <a href="signup.html#" class="scrollToTop scroll-btn"><img src="/assets/img/icon/click-top-btn.png"
            alt="img"></a>
