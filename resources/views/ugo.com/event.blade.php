                ...
                <div class="widget_shopping_cart_content">
                    <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="event.html#" class="remove remove_from_cart_button"><i
                                    class="far fa-times"></i></a>
                            <a href="event.html#"><img src="/assets/img/product/product_thumb_1_1.png"
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="event.html#" class="remove remove_from_cart_button"><i
                                    class="far fa-times"></i></a>
                            <a href="event.html#"><img src="/assets/img/product/product_thumb_1_2.png"
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="event.html#" class="remove remove_from_cart_button"><i
                                    class="far fa-times"></i></a>
                            <a href="event.html#"><img src="/assets/img/product/product_thumb_1_3.png"
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="event.html#" class="remove remove_from_cart_button"><i
                                    class="far fa-times"></i></a>
                            <a href="event.html#"><img src="/assets/img/product/product_thumb_1_4.png"
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="event.html#" class="remove remove_from_cart_button"><i
                                    class="far fa-times"></i></a>
                            <a href="event.html#"><img src="/assets/img/product/product_thumb_1_5.png"
 ...
 Header Area
                        ...
                        <ul class="navbar-top-right header-links">
                            ...
                            <li>
                                <div class="header-social">
                                    <a href="event.html#"><i class="fab fa-facebook-f"></i></a>
                                    <a href="event.html#"><i class="fab fa-twitter"></i></a>
                                    <a href="event.html#"><i class="fab fa-linkedin-in"></i></a>
                                    <a href="event.html#"><i class="fab fa-instagram"></i></a>
                                </div>
                            </li>
                        </ul>
                    </div>
    ...
    <div class="breadcumb-wrapper " data-bg-src="/assets/img/breadcumb/breadcumb-bg.png">
        ...
        <div class="bottom-shape">
            <img src="/assets/img/breadcumb/breadcumb-bg-bottom3.png" alt="img">
        </div>
    </div>
                    ...
                    <div class="event-card">
                        ...
                        <div class="details">
                            ...
                            <div class="meta">
                                ...
                                <a class="popup-video"
                                    href="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3644.7310056272386!2d89.2286059153658!3d24.00527418490799!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39fe9b97badc6151%3A0x30b048c9fb2129bc!2sTayde!5e0!3m2!1sen!2sbd!4v1651028958211!5m2!1sen!2sbd"><i
                                        class="fa-regular fa-location-dot"></i> New York 242 Dancing Street Lolion</a>
                            </div>
                            <a class="read-more-btn" href="event-details.html">Read More Details <i
                    ...
                    <div class="col-md-6 col-xxl-3 col-xl-3">
                        <div class="widget footer-widget">
                            <div class="as-widget-about">
                                ...
                                <div class="as-social">
                                    <a class="facebook" href="event.html#"><i class="fab fa-facebook-f"></i></a>
                                    <a class="goggle" href="event.html#"><i class="fab fa-google-plus-g"></i></a>
                                    <a class="twitter" href="event.html#"><i class="fab fa-twitter"></i></a>
                                    <a class="pinterest" href="event.html#"><i class="fab fa-pinterest-p"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="copyright-wrap" data-bg-src="/assets/img/bg/copyright_bg.png">
            <div class="container">
                <p class="copyright-text text-center">Copyright <i class="fal fa-copyright"></i> 2023 By <a
                        href="event.html#">Tayde</a>. All Rights Reserved.</p>
            </div>
        </div>
    </footer>
 ...
 ******************************** -->
    ...
    <!-- Scroll To Top -->
    <a href="event.html#" class="scrollToTop scroll-btn"><img src="/assets/img/icon/click-top-btn.png"
            alt="img"></a>
