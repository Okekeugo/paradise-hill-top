...
<body>
	...
	******************************** -->
                ...
                <div class="widget_shopping_cart_content">
                    <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="login.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="login.html#"><img src="assets/img/product/product_thumb_1_1.png" alt="Cart Image">Wooden Bunny</a>
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="login.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="login.html#"><img src="assets/img/product/product_thumb_1_2.png" alt="Cart Image">Kids Dinosour</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="login.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="login.html#"><img src="assets/img/product/product_thumb_1_3.png" alt="Cart Image">Small Truck</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="login.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="login.html#"><img src="assets/img/product/product_thumb_1_4.png" alt="Cart Image">Color Kid Truck</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="login.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="login.html#"><img src="assets/img/product/product_thumb_1_5.png" alt="Cart Image">Dog Pupet</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <ul class="navbar-top-right header-links">
                            ...
                            <li>
                                <div class="header-social">
                                    <a href="login.html#"><i class="fab fa-facebook-f"></i></a>
                                    <a href="login.html#"><i class="fab fa-twitter"></i></a>
                                    <a href="login.html#"><i class="fab fa-linkedin-in"></i></a>
    ...
    Login Area  
    ==============================-->
    <div class="space-extra2-top text-center space-bottom">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8">
                    <form action="https://angfuzsoft.com/html/tayde/demo/mail.php" method="POST" class="login-form ajax-contact">
                        <h2 class="form-title fw-extrabold">Login</h2>
                        <p class="form-text mb-md-5 mb-4">Don't have an account yet? <a href="signup.html">Sign up for free</a></p>
                        <div class="row">
                            <div class="form-group">
                                <input type="text" class="form-control style-white" name="name" id="name" placeholder="Your User Name (Or) Email Address">
                            </div>
                            <div class="form-group style-3">
                                ...
                                <a class="input-icon" href="login.html#"><i class="fal fa-eye"></i></a>
                            </div>
                            <div class="form-group col-6 text-start align-self-center">
                                <input class="style2" type="checkbox" id="remember">
                                <label for="remember">Remember Me</label>
                            </div>
                            <div class="form-group col-6 text-end">
                                <a class="read-more-btn" href="login.html#">Forgot Password?</a>
                            </div>
                            <div class="form-btn col-12 text-center">
                                <button class="as-btn w-100">Log In</button>
                            </div>
                        </div>
    ...
    <footer class="footer-wrapper footer-layout1" data-bg-src="assets/img/bg/footer_bg_1.png">
                    ...
                    <div class="col-md-6 col-xxl-3 col-xl-3">
                        <div class="widget footer-widget">
                            <div class="as-widget-about">
                                ...
                                <div class="as-social">
                                    <a class="facebook" href="login.html#"><i class="fab fa-facebook-f"></i></a>
                                    <a class="goggle" href="login.html#"><i class="fab fa-google-plus-g"></i></a>
                                    <a class="twitter" href="login.html#"><i class="fab fa-twitter"></i></a>
                                    <a class="pinterest" href="login.html#"><i class="fab fa-pinterest-p"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="copyright-wrap" data-bg-src="assets/img/bg/copyright_bg.png">
            <div class="container">
                <p class="copyright-text text-center">Copyright <i class="fal fa-copyright"></i> 2023 By <a href="login.html#">Tayde</a>. All Rights Reserved.</p>
            </div>
        </div>
    </footer>
	...
	******************************** -->
    ...
    <!-- Scroll To Top -->
    <a href="login.html#" class="scrollToTop scroll-btn"><img src="assets/img/icon/click-top-btn.png" alt="img"></a>
