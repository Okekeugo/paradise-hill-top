                ...
                <div class="widget_shopping_cart_content">
                    <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="login.html#" class="remove remove_from_cart_button"><i
                                    class="far fa-times"></i></a>
                            <a href="login.html#"><img src="/assets/img/product/product_thumb_1_1.png"
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="login.html#" class="remove remove_from_cart_button"><i
                                    class="far fa-times"></i></a>
                            <a href="login.html#"><img src="/assets/img/product/product_thumb_1_2.png"
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="login.html#" class="remove remove_from_cart_button"><i
                                    class="far fa-times"></i></a>
                            <a href="login.html#"><img src="/assets/img/product/product_thumb_1_3.png"
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="login.html#" class="remove remove_from_cart_button"><i
                                    class="far fa-times"></i></a>
                            <a href="login.html#"><img src="/assets/img/product/product_thumb_1_4.png"
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="login.html#" class="remove remove_from_cart_button"><i
                                    class="far fa-times"></i></a>
                            <a href="login.html#"><img src="/assets/img/product/product_thumb_1_5.png"
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8">
                    <form action="https://angfuzsoft.com/html/tayde/demo/mail.php" method="POST"
                        ...
                        <p class="form-text mb-md-5 mb-4">Don't have an account yet? <a href="signup.html">Sign up for
                                free</a></p>
                        <div class="row">
        ...
        <div class="copyright-wrap" data-bg-src="/assets/img/bg/copyright_bg.png">
            <div class="container">
                <p class="copyright-text text-center">Copyright <i class="fal fa-copyright"></i> 2023 By <a
                        href="login.html#">Tayde</a>. All Rights Reserved.</p>
            </div>
        </div>
    </footer>
 ...
 ******************************** -->
    ...
    <!-- Scroll To Top -->
    <a href="login.html#" class="scrollToTop scroll-btn"><img src="/assets/img/icon/click-top-btn.png"
            alt="img"></a>
