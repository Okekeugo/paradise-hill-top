...
<body>
	...
	******************************** -->
                ...
                <div class="widget_shopping_cart_content">
                    <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="team.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="team.html#"><img src="assets/img/product/product_thumb_1_1.png" alt="Cart Image">Wooden Bunny</a>
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="team.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="team.html#"><img src="assets/img/product/product_thumb_1_2.png" alt="Cart Image">Kids Dinosour</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="team.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="team.html#"><img src="assets/img/product/product_thumb_1_3.png" alt="Cart Image">Small Truck</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="team.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="team.html#"><img src="assets/img/product/product_thumb_1_4.png" alt="Cart Image">Color Kid Truck</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="team.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="team.html#"><img src="assets/img/product/product_thumb_1_5.png" alt="Cart Image">Dog Pupet</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <ul class="navbar-top-right header-links">
                            ...
                            <li>
                                <div class="header-social">
                                    <a href="team.html#"><i class="fab fa-facebook-f"></i></a>
                                    <a href="team.html#"><i class="fab fa-twitter"></i></a>
                                    <a href="team.html#"><i class="fab fa-linkedin-in"></i></a>
                                    <a href="team.html#"><i class="fab fa-instagram"></i></a>
                                </div>
                            </li>
                        </ul>
                    </div>
    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/breadcumb/breadcumb-bg.png">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Teachers</h1>
    ...
    Team Area 02 
    ==============================-->
    <section class="team-area-2 space-extra2">
        <div class="container">
            <div class="row gy-4">
                <!-- Single Item -->
                <div class="col-md-6 col-lg-4">
                    <div class="team-block" data-theme-color="#fe5a86">
                        ...
                        <div class="team-content">
                            <h3 class="team-title"><a href="team-details.html">Zasmine Yole</a></h3>
                            <span class="team-desig">Day Time Nanny</span>
                        </div>
                    </div>
                </div>
                <!-- Single Item -->
                <div class="col-md-6 col-lg-4">
                    <div class="team-block" data-theme-color="#FE5D37">
                        ...
                        <div class="team-content">
                            <h3 class="team-title"><a href="team-details.html">Afsana Herd</a></h3>
                            <span class="team-desig">Full Time Nanny</span>
                        </div>
                    </div>
                </div>
                <!-- Single Item -->
                <div class="col-md-6 col-lg-4">
                    <div class="team-block" data-theme-color="#786ACF">
                        ...
                        <div class="team-content">
                            <h3 class="team-title"><a href="team-details.html">David Smith</a></h3>
                            <span class="team-desig">Part Time Nanny</span>
                        </div>
                    </div>
                </div>
                <!-- Single Item -->
                <div class="col-md-6 col-lg-4">
                    <div class="team-block" data-theme-color="#AED139">
                        ...
                        <div class="team-content">
                            <h3 class="team-title"><a href="team-details.html">Backy Hest</a></h3>
                            <span class="team-desig">Full Time Nanny </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="team-block" data-theme-color="#fd9a23">
                        ...
                        <div class="team-content">
                            <h3 class="team-title"><a href="team-details.html">Jackline June</a></h3>
                            <span class="team-desig">Part Time Nanny</span>
                        </div>
                    </div>
                </div>
                <!-- Single Item -->
                <div class="col-md-6 col-lg-4">
                    <div class="team-block" data-theme-color="#54abf0">
                        <div class="team-img">
                        ...
                        <div class="team-content">
                            <h3 class="team-title"><a href="team-details.html">Daniel Maleo</a></h3>
                            <span class="team-desig">Part Time Nanny</span>
                        </div>
                    </div>
                </div>
    ...
    Call to Action Area  
    ==============================-->
    <div class="cta-area-2" data-bg-src="assets/img/bg/cta_bg_2.png">
        <!-- bg animated image -->
        <div class="anime-img-1 shape-mockup jump d-none d-lg-block" data-top="37%" data-left="5%"><img src="assets/img/cta/1.png" alt="img"></div>
        <div class="anime-img-2 shape-mockup jump2 d-none d-lg-block" data-top="35%" data-right="10%"><img src="assets/img/cta/2.png" alt="img"></div>
        <!-- bg animated image/ -->
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-7 col-md-10">
                    <div class="title-area mb-0 text-center">
                        <span class="cta-sub-title-2">Join Our New Session</span>
                        <h2 class="sec-title text-white">Call To Enroll Your Child
                            256 2158 2222
                        </h2>
                        <a class="as-btn style3 mb-0" href="contact.html">Contact Us</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-5 align-self-center">
                    <div class="about-thumb-3 mb-5 mb-lg-0">
                        <img class="thumbnail" src="assets/img/normal/about_3.png" alt="img">
                    </div>
                </div>
                <div class="col-xl-6 col-lg-7 align-self-center">
                    <div class="about-content-wrap-3">
                        <div class="title-area mb-0">
                            <h2 class="sec-title">Best Child Care Center</h2>
                            <p>Rapidiously target bleeding-edge solutions and enterprise methodologies. Objectively morph standards compliant methods of empowerment for sticky "outside the box" thinking. Monotonectally fashion premier interfaces before adaptive results. 
                            </p>
                            <div class="checklist style2">
                                <ul>
                                    <li>
                                        <i class="fa-regular fa-check-circle"></i>
                                        When pulled, it will move and hop like a real rabbit.
                                    </li>
                                    <li>
                                        <i class="fa-regular fa-check-circle"></i>
                                        Hopping Rabbit has a sweet face, flexible ears and real wood
                                    </li>
                                    <li>
                                        <i class="fa-regular fa-check-circle"></i>
                                        Big blue rear wheels to help prevent the from toppling over
                                    </li>
                                    <li>
                                        <i class="fa-regular fa-check-circle"></i>
                                        Smaller green front wheels make the toy maneuverable
                                    </li>
                                </ul>
                            </div>    
                            <a class="as-btn style5 mt-4" href="contact.html">Contact Us</a>                        
                        </div>
                    </div>                    
                </div>
            </div>
    ...
    <footer class="footer-wrapper footer-layout1" data-bg-src="assets/img/bg/footer_bg_1.png">
                    ...
                    <div class="col-md-6 col-xxl-3 col-xl-3">
                        <div class="widget footer-widget">
                            <div class="as-widget-about">
                                ...
                                <div class="as-social">
                                    <a class="facebook" href="team.html#"><i class="fab fa-facebook-f"></i></a>
                                    <a class="goggle" href="team.html#"><i class="fab fa-google-plus-g"></i></a>
                                    <a class="twitter" href="team.html#"><i class="fab fa-twitter"></i></a>
                                    <a class="pinterest" href="team.html#"><i class="fab fa-pinterest-p"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="copyright-wrap" data-bg-src="assets/img/bg/copyright_bg.png">
            <div class="container">
                <p class="copyright-text text-center">Copyright <i class="fal fa-copyright"></i> 2023 By <a href="team.html#">Tayde</a>. All Rights Reserved.</p>
            </div>
        </div>
    </footer>
	...
	******************************** -->
    ...
    <!-- Scroll To Top -->
    <a href="team.html#" class="scrollToTop scroll-btn"><img src="assets/img/icon/click-top-btn.png" alt="img"></a>
