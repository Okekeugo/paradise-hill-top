 ...
 ******************************** -->
    ...
    <div class="popup-search-box d-none d-lg-block">
        ...
        <form action="course-details.html#">
            ...
            <div class="as-mobile-menu">
                <ul>
                    <li class="menu-item-has-children">
                        <a href="course-details.html#">Home</a>
                        <ul class="sub-menu">
                            <li class="menu-item-has-children">
                                <a href="course-details.html#">Multipage</a>
                                <ul class="sub-menu">
                            ...
                            <li class="menu-item-has-children">
                                <a href="course-details.html#">Onepage</a>
                                <ul class="sub-menu">
                            ...
                            <li class="menu-item-has-children">
                                <a href="course-details.html#">RTL</a>
                                <ul class="sub-menu">
                    ...
                    <li class="menu-item-has-children">
                        <a href="course-details.html#">Services</a>
                        <ul class="sub-menu">
                    ...
                    <li class="menu-item-has-children">
                        <a href="course-details.html#">Classes</a>
                        <ul class="sub-menu">
                    ...
                    <li class="menu-item-has-children">
                        <a href="course-details.html#">Pages</a>
                        <ul class="sub-menu">
                    ...
                    <li class="menu-item-has-children">
                        <a href="course-details.html#">Shop</a>
                        <ul class="sub-menu">
                ...
                <div class="widget_shopping_cart_content">
                    <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="course-details.html#" class="remove remove_from_cart_button"><i
                                    class="far fa-times"></i></a>
                            <a href="course-details.html#"><img src="/assets/img/product/product_thumb_1_1.png"
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="course-details.html#" class="remove remove_from_cart_button"><i
                                    class="far fa-times"></i></a>
                            <a href="course-details.html#"><img src="/assets/img/product/product_thumb_1_2.png"
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="course-details.html#" class="remove remove_from_cart_button"><i
                                    class="far fa-times"></i></a>
                            <a href="course-details.html#"><img src="/assets/img/product/product_thumb_1_3.png"
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="course-details.html#" class="remove remove_from_cart_button"><i
                                    class="far fa-times"></i></a>
                            <a href="course-details.html#"><img src="/assets/img/product/product_thumb_1_4.png"
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="course-details.html#" class="remove remove_from_cart_button"><i
                                    class="far fa-times"></i></a>
                            <a href="course-details.html#"><img src="/assets/img/product/product_thumb_1_5.png"
 ...
 Header Area
                        ...
                        <ul class="navbar-top-right header-links">
                            ...
                            <li>
                                <div class="header-social">
                                    <a href="course-details.html#"><i class="fab fa-facebook-f"></i></a>
                                    <a href="course-details.html#"><i class="fab fa-twitter"></i></a>
                                    <a href="course-details.html#"><i class="fab fa-linkedin-in"></i></a>
                                    <a href="course-details.html#"><i class="fab fa-instagram"></i></a>
                                </div>
                            </li>
                        </ul>
                    </div>
    ...
    Course Details Area
    ==============================-->
    <section class="class-details-section space-extra2-top space-bottom">
        <div class="container">
            <div class="row gx-60">
                <div class="col-xl-8 col-lg-7">
                    <div class="course-details-inner">
                        <div class="row course-details-slider as-carousel" id="classBig" data-slide-show="1"
                            data-md-slide-show="1" data-fade="true">
                            <div class="col-12">
                                <img src="/assets/img/course/course-details-1.png" alt="class">
                            </div>
                            <div class="col-12">
                                <img src="/assets/img/course/course-details-2.png" alt="class">
                            </div>
                            <div class="col-12">
                                <img src="/assets/img/course/course-details-3.jpg" alt="class">
                            </div>
                            <div class="col-12">
                                <img src="/assets/img/course/course-details-4.jpg" alt="class">
                            </div>
                            <div class="col-12">
                                <img src="/assets/img/course/course-details-5.jpg" alt="class">
                            </div>
                            <div class="col-12">
                                <img src="/assets/img/course/course-details-6.jpg" alt="class">
                            </div>
                        </div>
                        <div class="row course-thumb as-carousel g-0" data-slide-show="5" data-lg-slide-show="4"
                            data-md-slide-show="5" data-sm-slide-show="3" data-xs-slide-show="3"
                            data-asnavfor="#classBig">
                            <div class="col-auto">
                                <img src="/assets/img/course/thumb-1.png" alt="class">
                            </div>
                            <div class="col-auto">
                                <img src="/assets/img/course/thumb-2.png" alt="class">
                            </div>
                            <div class="col-auto">
                                <img src="/assets/img/course/thumb-3.png" alt="class">
                            </div>
                            <div class="col-auto">
                                <img src="/assets/img/course/thumb-4.png" alt="class">
                            </div>
                            <div class="col-auto">
                                <img src="/assets/img/course/thumb-5.png" alt="class">
                            </div>
                            <div class="col-auto">
                                <img src="/assets/img/course/thumb-6.png" alt="class">
                            </div>
                        </div>
                        <h2 class="single-title">Multiple Topic Learning</h2>
                        <div class="service-content">
                            <p>Continually restore backward-compatible networks for goal-oriented results. Rapidiously
                                provide access to best of breed manufactured products whereas out-of-the-box "outside
                                the box" thinking. Assertively plagiarize error-free "outside the box" thinking rather
                                than optimal supply chains. Proactively benchmark flexible opportunities before
                                out-of-the-box materials. Authoritatively streamline multimedia based...
                            </p>
                            <p>Seize high-quality schemas with clicks-and-mortar initiatives. Collaboratively enhance
                                equity invested value via team building action items. Competently empower strategic
                                niche markets before long-term high-impact initiatives. life Synergistically
                                reintermediate just in time testing procedures vis-a-vis corporate internal</p>
                            <div class="checklist style3 mt-30 mb-30">
                                <ul>
                                    <li><i class="fa fa-check-circle"></i> Social Skill</li>
                                    <li><i class="fa fa-check-circle"></i> Circle Time</li>
                                    <li><i class="fa fa-check-circle"></i> Outdoor Activities</li>
                                    <li><i class="fa fa-check-circle"></i> Music Classes</li>
                                    <li><i class="fa fa-check-circle"></i> Self Help Skills</li>
                                    <li><i class="fa fa-check-circle"></i> Online Playing</li>
                                    <li><i class="fa fa-check-circle"></i> Finger Plays</li>
                                    <li><i class="fa fa-check-circle"></i> Focused Learning</li>
                                    <li><i class="fa fa-check-circle"></i> Konowledge Learning</li>
                                    <li><i class="fa fa-check-circle"></i> Sensory Activities</li>

                                    <li><i class="fa fa-check-circle"></i> Communication</li>
                                    <li><i class="fa fa-check-circle"></i> Task Practice</li>
                                    <li><i class="fa fa-check-circle"></i> Self - Selected Play</li>
                                    <li><i class="fa fa-check-circle"></i> Singing Songs</li>
                                    <li><i class="fa fa-check-circle"></i> Good Work</li>
                                </ul>
                            </div>
                            <p>Uniquely maximize stand-alone sources with out-of-the-box alignments. Continually
                                procrastinate alternative catalysts for change for user friendly processes. Dynamically
                                negotiate tactical e-markets for holistic web services. benchmark alternative
                                initiatives after clicks-and-mortar outsourcing. Conveniently customize strategic total
                                linkage through functional data. Progressively seize go forward potentialities with
                                end-to-end scenarios. Dynamically implement open-source web-readiness for robust
                                communities egotiate tactical e-markets for holistic web services</p>
                        </div>
                        <div class="as-register-form mt-50">
                            <div class="form-title">
                                <h3 class="form-title">Register For Your Child</h3>
                            </div>
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    <select name="classes" id="classselect"
                                        class="single-select nice-select style-white">
                                ...
                                <div class="col-12 form-group style-2">
                                    <textarea placeholder="Write a Comment" id="commentForm" class="form-control style-white"></textarea>
                                    <i class="far fa-pencil-alt form-icon-left"></i>
                                </div>
                                <div class="col-12">
                                    <button class="as-btn">
                                        <i class="fal fa-paper-plane me-2"></i> Submit Now </button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-4 col-lg-5">
                    <aside class="sidebar-area class-sidebar">
                        <div class="widget widget_info">
                            <div class="widget_title">Price: <span class="price">$45.00</span></div>
                            <div class="info-list">
                                <ul>
                                    <li class="info-item">
                                        <i class="fas fa-calendar-alt"></i>
                                        <strong class="title">Start Date: </strong>
                                        <span class="text">25 October, 2023</span>
                                    </li>
                                    <li class="info-item">
                                        <i class="fas fa-user"></i>
                                        <strong class="title">Student Ages:</strong>
                                        <span class="text">03 - 06 Years</span>
                                    </li>
                                    <li class="info-item">
                                        <i class="fas fa-users-class"></i>
                                        <strong class="title">Number Of Kids: </strong>
                                        <span class="text">30 Child</span>
                                    </li>
                                    <li class="info-item">
                                        <i class="fas fa-clock"></i>
                                        <strong class="title">Class Time: </strong>
                                        <span class="text">9:00am - 12:00pm</span>
                                    </li>
                                    <li class="info-item">
                                        <i class="fas fa-sunrise"></i>
                                        <strong class="title">Class Day: </strong>
                        ...
                        <div class="widget widget_author">
                            <div class="author-widget-wrap">
                                <div class="avater">
                                    <img src="/assets/img/widget/widget-author.png" alt="avator">
                                </div>
                                <div class="author-info">
                                    <h4 class="name">
                                        <a href="team-details.html">Sowat Ahsan</a>
                                    </h4>
                                    <span class="desig">Teacher</span>
                                </div>
                                <p class="author-bio">Gressively reinvent optimal expertise without go forward
                                    initiatives. virtual applications without resource.</p>
                                <div class="as-social">
                                    <a class="facebook" href="course-details.html#"><i
                                            class="fab fa-facebook-f"></i></a>
                                    <a class="goggle" href="course-details.html#"><i
                                            class="fab fa-google-plus-g"></i></a>
                                    <a class="twitter" href="course-details.html#"><i class="fab fa-twitter"></i></a>
                                    <a class="pinterest" href="course-details.html#"><i
        ...
        <div class="copyright-wrap" data-bg-src="/assets/img/bg/copyright_bg.png">
            <div class="container">
                <p class="copyright-text text-center">Copyright <i class="fal fa-copyright"></i> 2023 By <a
                        href="course-details.html#">Tayde</a>. All Rights Reserved.</p>
            </div>
        </div>
    </footer>
 ...
 ******************************** -->
    ...
    <!-- Scroll To Top -->
    <a href="course-details.html#" class="scrollToTop scroll-btn"><img src="/assets/img/icon/click-top-btn.png"
            alt="img"></a>
