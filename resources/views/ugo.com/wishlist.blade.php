...
<body>
	...
	******************************** -->
        ...
        <div class="as-menu-area text-center">
            ...
            <div class="as-mobile-menu">
                <ul>
                    ...
                    <li class="menu-item-has-children">
                        <a href="wishlist.html#">Services</a>
                        <ul class="sub-menu">
                        ...
                        <ul class="navbar-top-right header-links">
                            ...
                            <li>
                                <div class="header-social">
                                    <a href="wishlist.html#"><i class="fab fa-facebook-f"></i></a>
                                    <a href="wishlist.html#"><i class="fab fa-twitter"></i></a>
                                    <a href="wishlist.html#"><i class="fab fa-linkedin-in"></i></a>
                                    <a href="wishlist.html#"><i class="fab fa-instagram"></i></a>
                                </div>
                            </li>
                        </ul>
                    </div>
    ...
    Wishlist Area
    ==============================-->
    <div class="space-extra2-top space-bottom">
        <div class="container">
            <div class="tinv-wishlist woocommerce tinv-wishlist-clear">
                <div class="tinv-header">
                    <h2 class="mb-30">Wishlist</h2>
                </div>
                <form action="wishlist.html#" method="post" autocomplete="off">
                    ...
                    <li>
                        <div class="footer-contact-wrap">
                            ...
                            <div class="details">
                                ...
                                <h4 class="info"><a href="mailto:info@Tayder.com">info@Tayde.com</a></h4>
                            </div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="widget footer-widget">
                            <div class="as-widget-about">
                                ...
                                <div class="as-social">
                                    ...
                                    <a class="twitter" href="wishlist.html#"><i class="fab fa-twitter"></i></a>
                                    <a class="pinterest" href="wishlist.html#"><i class="fab fa-pinterest-p"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
