...
<body>
	...
	******************************** -->
                ...
                <div class="widget_shopping_cart_content">
                    <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="blog.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="blog.html#"><img src="assets/img/product/product_thumb_1_1.png" alt="Cart Image">Wooden Bunny</a>
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="blog.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="blog.html#"><img src="assets/img/product/product_thumb_1_2.png" alt="Cart Image">Kids Dinosour</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="blog.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="blog.html#"><img src="assets/img/product/product_thumb_1_3.png" alt="Cart Image">Small Truck</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="blog.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="blog.html#"><img src="assets/img/product/product_thumb_1_4.png" alt="Cart Image">Color Kid Truck</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="blog.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="blog.html#"><img src="assets/img/product/product_thumb_1_5.png" alt="Cart Image">Dog Pupet</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/breadcumb/breadcumb-bg.png">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Latest Post</h1>
                ...
                <div class="col-xxl-8 col-lg-7">
                    <div class="as-blog blog-single has-post-thumbnail">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a href="blog.html"><i class="fa-regular fa-user"></i>Tayde </a>
                                <a href="blog-details.html"><i class="fa-regular fa-tags"></i>Children</a>
                                <a href="blog.html"><i class="fal fa-calendar-alt"></i>22 June, 2023</a>
                            </div>
                            <h2 class="blog-title"><a href="blog-details.html">Monetize Models Effectively Sources that are open Reformulate Distributed Services</a>
                            </h2>
                            <p class="blog-text">In today’s world, building a business also means you’ll need a strong website and social media presence. These can help you learn your customers better. With them, you can even request customers’ email addresses so you can reach</p>
                            <a href="blog-details.html" class="read-more-btn">Read More <i class="fa fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="as-blog blog-single has-post-thumbnail">
                        ...
                        <div class="blog-content">
                            ...
                            <h2 class="blog-title"><a href="blog-details.html">Child education always grow ideas for knowledge sources
                                redefine distributed services</a>
                            </h2>
                            <p class="blog-text">Child education in today’s world, building a business also means you’ll need a strong website and media presence. These can help you learn your customers better. With them, you can even request customers’ email addresses so you can reach</p>
                            <a href="blog-details.html" class="read-more-btn">Read More <i class="fa fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="as-blog blog-single has-post-thumbnail">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a href="blog.html"><i class="fa-regular fa-user"></i>Tayde </a>
                                <a href="blog-details.html"><i class="fa-regular fa-tags"></i>Children</a>
                                <a href="blog.html"><i class="fal fa-calendar-alt"></i>12 July, 2023</a>
                            </div>
                            <h2 class="blog-title"><a href="blog-details.html">Always Grow
                                Ideas For Child Education Knowledge models transparent sources
                                </a>
                            </h2>
                            <p class="blog-text">Always grow in today’s world, building a business also means you’ll need a strong website and social media presence. These can help you learn your customers better. Which upon sad wight concubines. With them, you can even request customers’ email addresses so you can reach</p>
                            <a href="blog-details.html" class="read-more-btn">Read More <i class="fa fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="as-blog blog-single">
                        <div class="blog-content">
                            ...
                            <h2 class="blog-title"><a href="blog-details.html">Education Knowledge Always Grow Ideas For Child sources
                                redefine distributed services</a>
                            </h2>
                            <p class="blog-text">Child education in today’s world, building a business also means you’ll need a strong website and media presence. These can help you learn your customers better. With them, you can even request customers’ email addresses so you can reach</p>
                            <a href="blog-details.html" class="read-more-btn">Read More <i class="fa fa-long-arrow-right"></i></a>
                    ...
                    <div class="as-pagination text-center pt-20">
                        <ul>
                            ...
                            <li><a href="blog.html"><i class="fa-solid fa-ellipsis"></i></a></li>
                ...
                <div class="col-xxl-4 col-lg-5">
                    <aside class="sidebar-area">
                        ...
                        <div class="widget widget_categories  ">
                            ...
                            <ul>
                                <li>
                                    <a href="blog.html"><i class="fa-solid fa-circle-chevron-right"></i>Day Care Kids</a>
                                    <span>10</span>
                                </li>
                                <li>
                                    <a href="blog.html"><i class="fa-solid fa-circle-chevron-right"></i>Online Education</a>
                                    <span>07</span>
                                </li>
                                <li>
                                    <a href="blog.html"><i class="fa-solid fa-circle-chevron-right"></i>Pre School Works</a>
                                    <span>05</span>
                                </li>
                                <li>
                                    <a href="blog.html"><i class="fa-solid fa-circle-chevron-right"></i>Outdoor Playing</a>
                                    <span>02</span>
                                </li>
                            </ul>
                        </div>
    ...
    <footer class="footer-wrapper footer-layout1" data-bg-src="assets/img/bg/footer_bg_1.png">
                    ...
                    <div class="col-md-6 col-xxl-3 col-xl-3">
                        <div class="widget footer-widget">
                            <div class="as-widget-about">
                                ...
                                <div class="as-social">
                                    <a class="facebook" href="blog.html#"><i class="fab fa-facebook-f"></i></a>
                                    <a class="goggle" href="blog.html#"><i class="fab fa-google-plus-g"></i></a>
                                    <a class="twitter" href="blog.html#"><i class="fab fa-twitter"></i></a>
                                    <a class="pinterest" href="blog.html#"><i class="fab fa-pinterest-p"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="copyright-wrap" data-bg-src="assets/img/bg/copyright_bg.png">
            <div class="container">
                <p class="copyright-text text-center">Copyright <i class="fal fa-copyright"></i> 2023 By <a href="blog.html#">Tayde</a>. All Rights Reserved.</p>
            </div>
        </div>
    </footer>
	...
	******************************** -->
    ...
    <!-- Scroll To Top -->
    <a href="blog.html#" class="scrollToTop scroll-btn"><img src="assets/img/icon/click-top-btn.png" alt="img"></a>
