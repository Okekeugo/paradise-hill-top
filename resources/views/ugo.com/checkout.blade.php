...
<body>
	...
	******************************** -->
            ...
            <div class="as-mobile-menu">
                <ul>
                    <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            <li class="menu-item-has-children">
                                <a href="checkout.html#">Multipage</a>
                                <ul class="sub-menu">
                            ...
                            <li class="menu-item-has-children">
                                <a href="checkout.html#">Onepage</a>
                                <ul class="sub-menu">
                    ...
                    <li class="menu-item-has-children">
                        <a href="checkout.html#">Services</a>
                        <ul class="sub-menu">
                    ...
                    <li class="menu-item-has-children">
                        <a href="checkout.html#">Classes</a>
                        <ul class="sub-menu">
                ...
                <div class="widget_shopping_cart_content">
                    <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="checkout.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="checkout.html#"><img src="assets/img/product/product_thumb_1_1.png" alt="Cart Image">Wooden Bunny</a>
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="checkout.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="checkout.html#"><img src="assets/img/product/product_thumb_1_2.png" alt="Cart Image">Kids Dinosour</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="checkout.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="checkout.html#"><img src="assets/img/product/product_thumb_1_3.png" alt="Cart Image">Small Truck</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="checkout.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="checkout.html#"><img src="assets/img/product/product_thumb_1_4.png" alt="Cart Image">Color Kid Truck</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="checkout.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="checkout.html#"><img src="assets/img/product/product_thumb_1_5.png" alt="Cart Image">Dog Pupet</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <ul class="navbar-top-right header-links">
                            ...
                            <li>
                                <div class="header-social">
                                    <a href="checkout.html#"><i class="fab fa-facebook-f"></i></a>
                                    <a href="checkout.html#"><i class="fab fa-twitter"></i></a>
                                    <a href="checkout.html#"><i class="fab fa-linkedin-in"></i></a>
                                    <a href="checkout.html#"><i class="fab fa-instagram"></i></a>
                                </div>
                            </li>
                        </ul>
                    </div>
    ...
    Checkout Area
    ==============================-->
    <div class="as-checkout-wrapper space-extra2-top space-bottom">
        <div class="container">
            <div class="woocommerce-form-login-toggle">
                <div class="woocommerce-info">Returning customer? <a href="checkout.html#" class="showlogin">Click here to login</a>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <form action="checkout.html#" class="woocommerce-form-login">
                        ...
                        <div class="form-group">
                            ...
                            <p class="fs-xs mt-2 mb-0"><a class="text-reset" href="checkout.html#">Lost your password?</a></p>
                        </div>
                    </form>
                </div>
            </div>
            <div class="woocommerce-form-coupon-toggle">
                <div class="woocommerce-info">Have a coupon? <a href="checkout.html#" class="showcoupon">Click here to enter your code</a> </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <form action="checkout.html#" class="woocommerce-form-coupon">
                        <div class="form-group">
            ...
            <form action="checkout.html#" class="woocommerce-checkout mt-40">
                <div class="row ">
                    <div class="col-lg-6">
            ...
            <form action="checkout.html#" class="woocommerce-cart-form">
    ...
    <footer class="footer-wrapper footer-layout1" data-bg-src="assets/img/bg/footer_bg_1.png">
                    ...
                    <div class="col-md-6 col-xxl-3 col-xl-3">
                        <div class="widget footer-widget">
                            <div class="as-widget-about">
                                ...
                                <div class="as-social">
                                    <a class="facebook" href="checkout.html#"><i class="fab fa-facebook-f"></i></a>
                                    <a class="goggle" href="checkout.html#"><i class="fab fa-google-plus-g"></i></a>
                                    <a class="twitter" href="checkout.html#"><i class="fab fa-twitter"></i></a>
                                    <a class="pinterest" href="checkout.html#"><i class="fab fa-pinterest-p"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="copyright-wrap" data-bg-src="assets/img/bg/copyright_bg.png">
            <div class="container">
                <p class="copyright-text text-center">Copyright <i class="fal fa-copyright"></i> 2023 By <a href="checkout.html#">Tayde</a>. All Rights Reserved.</p>
            </div>
        </div>
    </footer>
	...
	******************************** -->
    ...
    <!-- Scroll To Top -->
    <a href="checkout.html#" class="scrollToTop scroll-btn"><img src="assets/img/icon/click-top-btn.png" alt="img"></a>
