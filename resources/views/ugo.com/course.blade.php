                        ...
                        <ul class="navbar-top-right header-links">
                            ...
                            <li>
                                <div class="header-social">
                                    <a href="course.html#"><i class="fab fa-facebook-f"></i></a>
                                    <a href="course.html#"><i class="fab fa-twitter"></i></a>
                                    <a href="course.html#"><i class="fab fa-linkedin-in"></i></a>
                                    <a href="course.html#"><i class="fab fa-instagram"></i></a>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="course-card">
                        ...
                        <div class="details">
                            ...
                            <h4 class="title"><a href="course-details.html">Kids Playground</a></h4>
                            <ul>
                                <li>
                                    <span>Age:</span>
                                    5-7 Years
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="course-card">
                        ...
                        <div class="details">
                            ...
                            <h4 class="title"><a href="course-details.html">Digital Learning Games</a></h4>
                            <ul>
                                <li>
                                    <span>Age:</span>
                                    8-10 Years
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="course-card">
                        ...
                        <div class="details">
                            ...
                            <h4 class="title"><a href="course-details.html">World Of Knowledge</a></h4>
                            <ul>
                                <li>
                                    <span>Age:</span>
                                    6-7 Years
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="title-area text-center">
                        <span class="sub-title-2">Testimonial</span>
                        <h2 class="sec-title">Parent Feedback
                        </h2>
                    </div>
                </div>
            </div>
                    ...
                    <div class="testi-box-2">
                        ...
                        <div class="testi-box_profile">
                            ...
                            <div class="details">
                                ...
                                <span class="testi-box_desig">Child Expert</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="widget footer-widget">
                            <div class="as-widget-about">
                                ...
                                <div class="as-social">
                                    ...
                                    <a class="twitter" href="course.html#"><i class="fab fa-twitter"></i></a>
                                    <a class="pinterest" href="course.html#"><i class="fab fa-pinterest-p"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
