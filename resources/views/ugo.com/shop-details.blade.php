...
<body>
	...
	******************************** -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="product-thumb">
                        ...
                        <a href="wishlist.html" class="add_to_wishlist"><i class="far fa-heart"></i></a>
                    </div>
                </div>
                <div class="col-lg-6 align-self-center">
                    <div class="product-about">
                        ...
                        <h2 class="product-title">Wood Showpiece</h2>
                        <p class="price">$65.00 - $95.00</p>
                        <p class="text">Competently cultivate bricks-and-clicks communities vis-a-vis vertical e-services. Completely streamline progressive mindshare without competitive total linkage. Continually orchestrate leading-edge vortals whereas functional opportunities fficiently disintermediate reliable human capital</p>
                        <div class="actions">
                            <span>Quantity</span>
                            <div class="quantity">
                        ...
                        <div class="product_meta">
                            <span class="sku_wrapper">SKU: <span class="sku">jumping-frog</span></span>
                            <span class="posted_in">Category: <a href="shop.html" rel="tag">Wooden Toys</a></span>
            ...
            <div class="as-mobile-menu">
                <ul>
                    <li class="menu-item-has-children">
                        <a href="shop-details.html#">Home</a>
                        <ul class="sub-menu">
                            <li class="menu-item-has-children">
                                <a href="shop-details.html#">Multipage</a>
                                <ul class="sub-menu">
                            ...
                            <li class="menu-item-has-children">
                                <a href="shop-details.html#">Onepage</a>
                                <ul class="sub-menu">
                            ...
                            <li class="menu-item-has-children">
                                <a href="shop-details.html#">RTL</a>
                                <ul class="sub-menu">
                    ...
                    <li class="menu-item-has-children">
                        <a href="shop-details.html#">Services</a>
                        <ul class="sub-menu">
                    ...
                    <li class="menu-item-has-children">
                        <a href="shop-details.html#">Classes</a>
                        <ul class="sub-menu">
                    ...
                    <li class="menu-item-has-children">
                        <a href="shop-details.html#">Pages</a>
                        <ul class="sub-menu">
                ...
                <div class="widget_shopping_cart_content">
                    <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="shop-details.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="shop-details.html#"><img src="assets/img/product/product_thumb_1_1.png" alt="Cart Image">Wooden Bunny</a>
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="shop-details.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="shop-details.html#"><img src="assets/img/product/product_thumb_1_2.png" alt="Cart Image">Kids Dinosour</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="shop-details.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="shop-details.html#"><img src="assets/img/product/product_thumb_1_3.png" alt="Cart Image">Small Truck</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="shop-details.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="shop-details.html#"><img src="assets/img/product/product_thumb_1_4.png" alt="Cart Image">Color Kid Truck</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="shop-details.html#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="shop-details.html#"><img src="assets/img/product/product_thumb_1_5.png" alt="Cart Image">Dog Pupet</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <ul class="navbar-top-right header-links">
                            ...
                            <li>
                                <div class="header-social">
                                    ...
                                    <a href="shop-details.html#"><i class="fab fa-linkedin-in"></i></a>
                                    <a href="shop-details.html#"><i class="fab fa-instagram"></i></a>
                                </div>
                            </li>
                        </ul>
                    </div>
    ...
    Product Details
    ==============================-->
    <section class="product-details space-extra2-top space-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="product-thumb">
                ...
                <div class="col-lg-6 align-self-center">
                    <div class="product-about">
                        ...
                        <h2 class="product-title">Puppet Dog</h2>
                        <p class="price">$55.00 - $85.00</p>
                        <p class="text">Bricks-and-clicks competently cultivate communities vis-a-vis vertical e-services. Completely streamline progressive mindshare without competitive total linkage. Continually orchestrate leading-edge vortals whereas functional opportunities fficiently disintermediate reliable human capital</p>
                        <div class="actions">
                            <span>Quantity</span>
                            <div class="quantity">
                                <button class="quantity-minus qty-btn"><i class="fa-solid fa-minus"></i></button>
                        ...
                        <div class="product_meta">
                            <span class="sku_wrapper">SKU: <span class="sku">Puppet Dog</span></span>
                            <span class="posted_in">Category: <a href="shop.html" rel="tag">Puppet Toys</a></span>
                            <span>Tags: <a href="shop.html">Baby</a><a href="shop.html">Toys</a><a href="shop.html"> Children</a></span>
                        </div>
                    </div>
                </div>
            </div>
            <ul class="nav product-tab-style1" id="productTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="description-tab" data-bs-toggle="tab" href="shop-details.html#description" role="tab" aria-controls="description" aria-selected="false">Description</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="description-tab" data-bs-toggle="tab" href="shop-details.html#add_info" role="tab" aria-controls="add_info" aria-selected="false">Additional Information</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="reviews-tab" data-bs-toggle="tab" href="shop-details.html#reviews" role="tab" aria-controls="reviews" aria-selected="true">Reviews (02)</a>
                </li>
            </ul>
            <div class="tab-content" id="productTabContent">
                <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                    <p>Interactively cultivate interdependent customer service without clicks-and-mortar e-services. Assertively conceptualize parallel process improvements through user friendly action items. Proactively cultivate go forward testing procedures with accurate quality vectors. Globally embrace ethical functionalities via empowered scenarios. Phosfluorescently restore highly efficient opportunities and client-focused infomediaries.</p>
                    <p>Au pauvre majesté voici long ronge l'amour hélas yeux sur de. La divinement qui me la au miraculeux comme, ou qu'elle doué grimace doué charmer fatale, pleure-t-elle et morceau pleurs trésor «la trôner demain qu'elle ton, ou genre musculeux elle.</p>
                    <div class="checklist style2 mb-20">
                        <ul>
                            <li>
                                <i class="fa-regular fa-circle-check"></i>
                                Conveniently network high-quality materials whereas
                            </li>
                            <li>
                                <i class="fa-regular fa-circle-check"></i>
                                Competitive content horitatively engage supply chains
                            </li>
                            <li>
                                <i class="fa-regular fa-circle-check"></i>
                                Existing reliable functionalities whereas synergistic
                            </li>
                            <li>
                                <i class="fa-regular fa-circle-check"></i>
                                Globally leverage existing magneti after maintainable
                            </li>
                        </ul>
                    </div>
                    <p class="mb-0">Erfreuet sich erste was im sich. Verklungen widerklang lispelnd sonst sich. Die schwankende selbst tönen das ihr die wenn. Dunst ersten zerstoben einst blick nun nebel, diesmal die in wirklichkeiten sich erste wird erste tage, unbestimmten macht liebe der seh erste.Es gedränge seh zu ein einst ihr, und jenem. Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit molestiae odio mollitia iste at, quam deleniti odit. Hic maiores iure quis consequatur libero nulla, ipsum accusantium quos, iste, alias non?</p>
                </div>
                <div class="tab-pane fade" id="add_info" role="tabpanel" aria-labelledby="add_info-tab">
                    <table class="woocommerce-table">
                        <tbody>
                            <tr>
                                <th>Brand</th>
                                <td><img src="assets/img/brand/brand_1_1.png" alt="logo"></td>
                            </tr>
                            <tr>
                                <th>Color</th>
                                <td>Yellow</td>
                        ...
                        <div class="as-comment-form ">
                            ...
                            <div class="row">
                                <div class="form-group rating-select d-flex align-items-center">
                                    ...
                                    <p class="stars">
                                        <span>
                                            <a class="star-1" href="shop-details.html#">1</a>
                                            <a class="star-2" href="shop-details.html#">2</a>
                                            <a class="star-3" href="shop-details.html#">3</a>
                                            <a class="star-4" href="shop-details.html#">4</a>
                                            <a class="star-5" href="shop-details.html#">5</a>
                                        </span>
                                    </p>
                                </div>
                                ...
                                <div class="col-md-6 form-group style-2">
                                    ...
                                    <i class="far fa-user form-icon-left"></i>
                                </div>
                                <div class="col-md-6 form-group style-2">
                                    <input type="text" placeholder="Your Email" class="form-control">
                                    <i class="far fa-envelope form-icon-left"></i>
                                </div>
            ...
            <div class="space-top mb-30">
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-8 text-center">
                        <div class="title-area">
                            <h2 class="sec-title">Related Shop</h2>
                ...
                <div class="row as-carousel" id="productCarousel" data-slide-show="4" data-lg-slide-show="3" data-md-slide-show="2" data-sm-slide-show="2" data-xs-slide-show="1">

                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="as-product product-grid">
                            <div class="product-img">
                                <img src="assets/img/product/product_1_1.png" alt="Product Image">
                                <div class="actions">
                                    <a href="shop-details.html#QuickView" class="icon-btn popup-content"><i class="far fa-eye"></i></a>
                            ...
                            <div class="product-content">
                                ...
                                <h3 class="product-title"><a href="shop-details.html">Kids Dinosour</a></h3>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="as-product product-grid">
                            ...
                            <div class="product-content">
                                ...
                                <h3 class="product-title"><a href="shop-details.html">Car Showpiece</a></h3>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="as-product product-grid">
                            ...
                            <div class="product-content">
                                ...
                                <h3 class="product-title"><a href="shop-details.html">Toys Dinosour </a></h3>
                                <span class="price">$250.00</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="as-product product-grid">
                            ...
                            <div class="product-content">
                                ...
                                <h3 class="product-title"><a href="shop-details.html">Busket Toys </a></h3>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="as-product product-grid">
                            ...
                            <div class="product-content">
                                ...
                                <h3 class="product-title"><a href="shop-details.html">Puppy Puppet</a></h3>
    ...
    <footer class="footer-wrapper footer-layout1" data-bg-src="assets/img/bg/footer_bg_1.png">
                    ...
                    <div class="col-md-6 col-xxl-3 col-xl-3">
                        <div class="widget footer-widget">
                            <div class="as-widget-about">
                                ...
                                <div class="as-social">
                                    <a class="facebook" href="shop-details.html#"><i class="fab fa-facebook-f"></i></a>
                                    <a class="goggle" href="shop-details.html#"><i class="fab fa-google-plus-g"></i></a>
                                    <a class="twitter" href="shop-details.html#"><i class="fab fa-twitter"></i></a>
                                    <a class="pinterest" href="shop-details.html#"><i class="fab fa-pinterest-p"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="copyright-wrap" data-bg-src="assets/img/bg/copyright_bg.png">
            <div class="container">
                <p class="copyright-text text-center">Copyright <i class="fal fa-copyright"></i> 2023 By <a href="shop-details.html#">Tayde</a>. All Rights Reserved.</p>
            </div>
        </div>
    </footer>
	...
	******************************** -->
    ...
    <!-- Scroll To Top -->
    <a href="shop-details.html#" class="scrollToTop scroll-btn"><img src="assets/img/icon/click-top-btn.png" alt="img"></a>
